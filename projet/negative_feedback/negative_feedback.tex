...
En analysant le circuit de notre haut-parleur, nous avons découvert la présence d'une boucle reliant la sortie et la borne négative de chaque amplificateur. Nous nous sommes alors interrogés sur le rôle de ces boucles.
...
Le principe de la réaction est présent dans un grand nombre de circuits électriques. Il consiste en une réinjection d'une partie du signal de sortie à l'entrée du circuit pour le combiner avec le signal d'entrée extérieur.
